...
<section class="content">
    <div class="box box-info">
        <div class="box-header text-center">
            <h3 class="box-title"><i class="fa fa-cog" aria-hidden="true"></i> App Settings </h3>
        </div>
        <div class="box-body">
    			...
    			?>
                    <?php echo form_open('Layout/details',$Contact_attributes); ?>
                        ...
                        <div class="form-group">
                            ...
                            <?php
                                $data = array('class'=>'form-control','type'=>'email', 'value'=>$company_record[0]->email ,'name'=>'company_email');
                                echo form_input($data);
                             ?>
                        </div>
                        <div class="form-group">
                            ...
                            <?php
                                $data = array('class'=>'form-control','type'=>'number', 'value'=>$company_record[0]->contact ,'name'=>'company_contact');
                                echo form_input($data);
                             ?>
                        </div>
                        <div class="form-group">
                            ...
                            <?php
                                $data = array('class'=>'form-control','type'=>'text', 'value'=>$company_record[0]->address ,'name'=>'company_address');
                                echo form_input($data);
                             ?>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <?php
                                $data = array('class'=>'btn btn-info btn-flat btn-lg','type' => 'submit','name'=>'save_company_details','value'=>'true', 'content' => '<i class="fa fa-floppy-o" aria-hidden="true"></i> Save Settings');
                                echo form_button($data);
                             ?>
                        </div>
                    <?php echo form_close(); ?>
