    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="pull pull-right">
                <button type="button" onclick="show_modal_page('<?php echo base_url();?>product/popup/add_product_model')" class="btn btn-info btn-flat " ><i class="fa fa-plus-square" aria-hidden="true"></i>
                    Add Product/Service
                </button>
                    ...
                    <div class="col-md-12 table-responsive">
                        <table id="" class="table table-bordered table-striped">
                            ...
                            ?>
                                <tr>
                                    <td>
                                        <?php echo '<b>'.'Product/Service'.'</b> '.$single_product->product_name; ?>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="btn-group pull no-print pull-right">
                                            ...
                                            <ul class="dropdown-menu" role="menu">
                                                <li onclick="show_modal_page('<?php echo base_url().'product/popup/edit_product_model/'.$single_product->id; ?>')" ><a href="#"><i class="fa fa-pencil"></i> Edit</a></li>
                                                <li>
                                                    <a  onclick="confirmation_alert(' delete this ','<?php echo base_url().'product/delete/'.$single_product->id; ?>')"  href="javascript:void(0)" ><i class="fa fa-trash-o"></i> Delete
                                                    </a>
                                                </li>   
                                                </ul>
                                        </div>
