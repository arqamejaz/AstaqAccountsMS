<div class="row">
  <div class="col-md-12">
        <ol class="breadcrumb pull-left">
            ...
            <li class="active"> Create refund receipt</li>
        </ol>
  </div> 
</div>
<div class="invoice">
  <section>
      <div class="row">
        <h4 class="purchase-heading">
          <i class="fa fa-plus-circle"></i> Refund Receipt
          <span class="pull-right bank-section-details">
           ...
           <small>Create refund of your sales</small>
        </h4>
      </div>
  </section>
  <section class="content">
        <div class="box" id="print-section">
          <div class="box-body ">
            ...
            ?>
            <?php echo form_open_multipart('refund_receipt/add_refund_receipt',$attributes); ?>
            <div class="row">
               ...
               <div class="col-md-3 col-sm-12">
                  <div class="form-group">
                      ...
                      <?php               
                          $data = array('class'=>'form-control input-lg ','type'=>'date','name'=>'refund_receipt_date','reqiured'=>'');
                          echo form_input($data);             
                      ?>
                  </div>
                </div>    
                  ...
                  <div class="col-md-12 table-responsive">
                       <table class="table table-striped table-hover  ">
                           <thead class="purchase-heading">
                            <tr>
                               <td class="col-md-2 ">Product/Service (<a  onclick="show_modal_page('<?php echo base_url();?>refund_receipt/popup/add_product_model')" class="add-product-link" href="#"> Add New </a>)</td>
                           ...
                           <tbody  id="transaction_table_body" >
                              <tr>
                                 ...
                                 <td>
                                      <?php
                                          $data = array('class'=>'form-control input-lg sales_tax','type'=>'number','name'=>'tax[]','id'=>'sales_tax','step'=>'.01','reqiured'=>'','value'=>'0','readonly'=>'readonly');
                                          echo form_input($data); 
                           ...
                           <tfoot>                    
                              ...
                              <tr>
                                 ...
                                 <td>
                                      <?php 
                                       $data = array('type'=>'number','name'=>'total_refunded','step'=>'.01','value'=>'0.00','class'=>'total_bill bill-total-settings','reqiured'=>'');
                                          echo form_input($data);
                                      ?>
                                 </td>
                              </tr>                              
