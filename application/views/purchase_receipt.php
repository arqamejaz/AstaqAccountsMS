...
<div class="invoice">
  <section>
      <div class="row">
        <h4 class="purchase-heading">
          <i class="fa fa-plus-circle"></i> Purchase Receipt
          <small>Create purchase receipt for your purchases
  ...
  <section class="content">
        <div class="box" id="print-section">
          <div class="box-body ">
            <?php
                $attributes = array('id'=>'add_purchase','method'=>'post','class'=>'');
            ?>
                  ...
                  <div class="col-md-12 table-responsive">
                       <table class="table table-striped table-hover  ">
                           <thead class="purchase-heading">
                            <tr>
                               <td class="col-md-2 ">Product/Service (<a  onclick="show_modal_page('<?php echo base_url();?>purchase/popup/add_product_model')" class="add-product-link" href="#"> Add New </a>)</td>
                           ...
                           <tfoot>                    
                              ...
                              <tr>
                                 <td colspan="4"></td>
                                 <td class=" expense-total-settings">Total Bill</td>
                                 <td>
                                     <?php 
                                       $data = array('type'=>'number','name'=>'total_bill','step'=>'.01','value'=>'0.00','readonly'=>'readonly','class'=>'   bill-total-settings received','reqiured'=>'');
                                          echo form_input($data);
                                      ?>
                                 </td>
                              </tr>                              
                              <tr>
                                 ...
                                 <td>
                                     <?php 
                                       $data = array('type'=>'number','name'=>'total_paid','step'=>'.01','value'=>'0.00','class'=>'received bill-total-settings','reqiured'=>'');
                                          echo form_input($data);
                                      ?>
                                 </td>
                              </tr> 
