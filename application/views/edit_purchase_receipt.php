...
<div class="invoice">
  <section>
      <div class="row">
        <h4 class="purchase-heading">
          <i class="fa fa-pencil"></i> Purchase Receipt
          <small>Update purchase receipt for your purchase
  ...
  <section class="content">
        <div class="box" id="print-section">
          <div class="box-body ">
            <?php
                $attributes = array('id'=>'update_purchase','method'=>'post','class'=>'');
            ?>
            <?php echo form_open_multipart('purchase/update_purchase',$attributes); ?>
            <div class="row">
               ...
               <div class="col-md-3 col-sm-12">
                  <div class="form-group">
                      <?php echo form_label('Purchase receipt date :'); ?>
                      <?php               
                  ...
                  <div class="col-md-12 table-responsive">
                       <table class="table table-striped table-hover  ">
                                      ...
                                      <select class="form-control select2 "  name="product[]" id="product_name">
                                          ...
                                          {       
                                              foreach ($product_list as $single_product)
                                              {
                                                ...
                                                {
                                          ?>
                                                  <option <?php echo ($single_item->product_id == $single_product->id) ? 'selected': ''; ?>  data-price="<?php echo $single_product->cost; ?>" data-description="<?php echo $single_product->description; ?>" data-tax="<?php echo $single_product->sale_tax; ?>" value="<?php echo $single_product->id; ?>" ><?php echo $single_product->product_name; ?> 
                                                  </option>
                                          <?php
                                                  }
                                              }
                           ...
                           <tfoot>                    
                               <tr>
                                   <td colspan="4">
                                      <button type="button" class="btn btn-primary btn-add-setting" name="addline" onclick="add_new_row('<?php echo base_url().'purchase/popup/new_purhcase_row';?>')"> <i class="fa fa-plus-circle"></i>    Add a line 
                                      </button> 
                              ...
                              <tr>
                                 <td colspan="4"></td>
                                 <td class=" expense-total-settings">Total Paid</td>
                                 <td>
                                     <?php 
                                       $data = array('type'=>'number','name'=>'total_paid','step'=>'.01','value'=>$parent_row[0]->total_paid,'class'=>'received bill-total-settings','reqiured'=>'');
                                          echo form_input($data);
                                      ?>
                                 </td>
                              </tr>
                      ...
                      <div class="col-md-5 ">
                        <div class="form-group">
                            <?php echo form_label('Message displayed on purchase receipt :'); ?>
                            <?php               
                      ...
                      <div class="col-md-7">
                        <span class="pull-right">
                          <img class="img-setting" src="<?php echo base_url('uploads/purchase/').$parent_row[0]->attachment;?>" >
                        </span>
                      </div>                  
                      <div class="col-md-12 ">
                          <div class="form-group">
