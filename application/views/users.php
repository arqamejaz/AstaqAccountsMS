    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="pull pull-right">
                <button type="button" onclick="show_modal_page('<?php echo base_url();?>users/popup/add_user_model')" class="btn btn-info btn-flat" ><i class="fa fa-plus-square" aria-hidden="true"></i>
                    Add user
                </button>
