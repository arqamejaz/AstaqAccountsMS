    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="pull pull-right">
                <a href="<?php echo base_url('purchase/add_purchase_form'); ?>" class="btn btn-info btn-flat"><i class="fa fa-plus-square" aria-hidden="true"></i>
            ...
            <div class="box-body">
                ...
                <div class="row no-print">
                    ...
                    <div class="col-md-3 col-sm-4">
                        <div class="form-group">
                            <?php
                                $data = array('class'=>'btn btn-info','type' => 'submit','name'=>'btnSubmit','value'=>'true', 'content' => '<i class="fa fa-search" aria-hidden="true"></i> Purchase receipts');
                    ...
                    <?php
        				...
        				if($purchases_record != NULL)
                        {
        					...
        					foreach ($purchases_record as $single_purchase)
                            {
                                 ...
                                 $total_paid =  $total_paid + $single_purchase->total_paid;
        				?>
                        <tr >
                            <td>
                                <?php echo $counter; ?>
                            ...
                            <div class="btn-group pull no-print pull-right">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li ><a href="<?php echo base_url().'prints/purchase/'.$single_purchase->id; ?>"><i class="fa fa-link"></i> Preview</a>
                                    </li>
                                    <?php 
                                    if($single_purchase->attachment != 'default.jpg')
                                    {
                                    ?> 
                                    <li ><a href="<?php echo base_url().'purchase/view_attachment/'.$single_purchase->id; ?>"><i class="fa fa-paperclip"></i> 
                                        View Attachment </a>
                                    </li> 
                                    <?php 
                                    }
                                    ...
                                    <li ><a href="<?php echo base_url().'purchase/edit_purchase_form/'.$single_purchase->id; ?>"><i class="fa fa-pencil"></i> Edit</a>
                                    </li>  
                                </ul>
                            </div>
                        </td> 
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <th  ><?php echo $this->db->get_where('mp_langingpage', array('id' => 1))->result_array()[0]['currency'] ;?> <?php echo number_format($total_bill,'2','.','') ?></th>
                                 <th colspan="4"><?php echo $this->db->get_where('mp_langingpage', array('id' => 1))->result_array()[0]['currency'] ;?> 
...
<script type="text/javascript">
    ...
    {
        window.location = '<?php echo base_url('purchase/index/')?>'+period;
