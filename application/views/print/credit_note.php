	...
	<div class="row">
	  <div class="col-md-12">
			<ol class="breadcrumb pull-right">
				...
				<li class="active"> Print credit notes</li>
			</ol>
	  </div>
	</div>
	<div class="row">
...
<section class="content" id="print-section">
	<div class="invoice invoice-body">
		...
		<div class="row">
		   <div class="col-md-12">
				<h2 class="invoice-title"><b>CREDIT NOTE</b></h2>
		   </div>
	   </div>
	   <div class="row set-border-bottom">
		   <div class="col-md-4 col-sm-4 pull-left">
				...
				<p > <?php echo $credit_data[0]->billing; ?></p>
		   </div>
		   <div class="col-md-4 col-sm-4 pull-right">
				<span class="pull-right">
					<h4 ><b class="invoice-heading"> CREDIT NO </b><span class="pull-right" > <?php echo $credit_data[0]->id; ?></span></h4>
					<h4 ><b class="invoice-heading"> DATE  </b> <span class="pull-right" > <?php echo $credit_data[0]->credit_date; ?> </span></h4>
				</span>
		   </div>
	   ...
	   <div class="row">
		   <div class="col-md-12">
			   <p>Message : <?php echo $credit_data[0]->message; ?></p>
		   </div>
	   </div>
	   <div class="row">
		   <div class="col-md-12">
