        ...
        <div class="col-md-6">
            <div class="pull pull-left">
                <ol class="breadcrumb pull-left">
                    ...
                    <li class="active">Bank payment collection </li>
                </ol>
            </div>
        </div>
        <div class="col-md-6">
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box" id="print-section">
                ...
                <div class="box-body">
                <?php
                    $attributes = array('id'=>'payment_collection','method'=>'post','class'=>'');
                ?>
                <?php echo form_open('bank/payment_collection',$attributes); ?>
                <div class="row no-print">
                    ...
                    <div class="col-md-3 col-sm-4">
                        <div class="form-group">
                            <?php
                                $data = array('class'=>'btn btn-info','type' => 'submit','name'=>'btnSubmit','value'=>'true', 'content' => '<i class="fa fa-search" aria-hidden="true"></i> Search collection');
...
<script type="text/javascript">
    ...
    {
        window.location = '<?php echo base_url('bank/payment_collection/'); ?>'+period;
