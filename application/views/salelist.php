    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="pull pull-right">
                <a href="<?php echo base_url('sales/add_sales_form'); ?>" class="btn btn-info btn-flat"><i class="fa fa-plus-square" aria-hidden="true"></i>
                            ...
                            <div class="btn-group pull no-print pull-right">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    ...
                                    <?php 
                                        ...
                                        {
                                        ?> 
                                        <li ><a href="<?php echo base_url().'sales/view_attachment/'.$single_sale->id; ?>"><i class="fa fa-paperclip"></i> 
                                            View Attachment </a>
                                        </li> 
                                        <?php 
                                        }
                                    ?>
                                     <li ><a  onclick="confirmation_alert('send mail  ','<?php echo base_url().'sales/sendmail/'.$single_sale->id; ?>')"  href="javascript:void(0)" ><i class="fa fa-envelope"></i> Mail receipt</a>
                                    </li>  
                                    <li ><a href="<?php echo base_url().'sales/edit_sales_form/'.$single_sale->id; ?>"><i class="fa fa-pencil"></i> Edit</a>
                                    </li>  
                                </ul>
                            </div>
                        </td> 
...
<script type="text/javascript">
    ...
    {
        window.location = '<?php echo base_url('sales/index/')?>'+period;
