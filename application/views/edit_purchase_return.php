<div class="row">
  <div class="col-md-12">
    <ol class="breadcrumb pull-left">
        ...
        <li>
          <a href="<?php echo base_url('purchase_return'); ?>"> Purchase return</a>
        </li>
  ...
  <section>
      <div class="row">
        <h4 class="purchase-heading">
          <i class="fa fa-pencil"></i> Purchase Return Receipt
          <small>Update purchase return receipt for your purchase return
  ...
  <section class="content">
        <div class="box" id="print-section">
          <div class="box-body ">
            ...
            ?>
            <?php echo form_open_multipart('purchase_return/update_purchase_return',$attributes); ?>
            <div class="row">
               ...
               <div class="col-md-3 col-sm-12">
                  <div class="form-group">
                      <?php echo form_label('PR receipt date :'); ?>
                      <?php               
                  ...
                  <div class="col-md-12 table-responsive">
                           ...
                           <tfoot>                    
                             <tr>
                              ...
                              <tr>
                                 ...
                                 <td>
                                     <?php 
                                       $data = array('type'=>'number','name'=>'total_received','step'=>'.01','value'=>$parent_row[0]->total_paid,'class'=>'received bill-total-settings','reqiured'=>'');
                                          echo form_input($data);
                                      ?>
                                 </td>
                              </tr>
                      ...
                      <div class="col-md-7">
                        <span class="pull-right">
                          <img class="img-setting" src="<?php echo base_url('uploads/purchase_return/').$parent_row[0]->attachment;?>" >
                        </span>
                      </div>                    
                      <div class="col-md-12 ">
                          <div class="form-group">
