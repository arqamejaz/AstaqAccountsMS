<div class="row">
  <div class="col-md-12">
    <ol class="breadcrumb pull-left">
        ...
        <li class="active"> Edit refund receipt</li>
    </ol>
  </div> 
</div>
<div class="invoice">
  <section>
      <div class="row">
        <h4 class="purchase-heading">
          <i class="fa fa-pencil"></i> Refund Receipt <br />
          <small>
             Update refund of your account holder request
  ...
  <section class="content">
        <div class="box" id="print-section">
          <div class="box-body ">
            <?php
                $attributes = array('id'=>'update_refund','method'=>'post','class'=>'');
            ?>
            <?php echo form_open_multipart('refund_receipt/update_refund_receipt',$attributes); ?>
            <div class="row">
               ...
               <div class="col-md-3 col-sm-12">
                  <div class="form-group">
                      <?php echo form_label('Refund Receipt date :'); ?>
                      <?php               
                          $data = array('class'=>'form-control input-lg ','type'=>'date','name'=>'refund_receipt_date','value'=>$parent_row[0]->receipt_date,'reqiured'=>'');
                          echo form_input($data);             
                      ?>
                  </div>
                </div>    
              ...
              <div class="row">
                  <div class="col-md-12 table-responsive">
                       <table class="table table-striped table-hover  ">
                           ...
                           <tfoot>                    
                              ...
                              <tr>
                                 ...
                                 <td>
                                     <?php 
                                       $data = array('type'=>'number','name'=>'total_refunded','step'=>'.01','value'=>$parent_row[0]->total_paid,'class'=>'total_bill bill-total-settings','reqiured'=>'');
                                          echo form_input($data);
                                      ?>
                                 </td>
                              </tr>                              
                      ...
                      <div class="col-md-5 ">
                        <div class="form-group">
                            <?php echo form_label('Message displayed on refund receipt :'); ?>
                            <?php               
                                $data = array('class'=>'form-control input-lg ','type'=>'text','name'=>'invoicemessage','value'=>$parent_row[0]->message,'reqiured'=>'');
                                echo form_input($data);             
                            ?>
                        </div>                        
                        <div class="form-group">
                            ...
                            <label> <i class="fa fa-paperclip" aria-hidden="true" ></i> Attachments  Maximum size: 25MB</label>
                              <?php               
                                  ...
                                  echo form_input($data); 
                                   ...
                                   $data = array('class'=>'','type'=>'hidden','name'=>'refund_id','value'=>$parent_row[0]->id);
                                  echo form_input($data);
                      ...
                      <div class="col-md-7">
                        <span class="pull-right">
                          <img class="img-setting" src="<?php echo base_url('uploads/refund_reciept/').$parent_row[0]->attachment;?>" >
                        </span>
                      </div>                     
                      <div class="col-md-12 ">
                          <div class="form-group">
