<div class="row">
  <div class="col-md-12">
        <ol class="breadcrumb pull-left">
            ...
            <li class="active"> Edit credit notes</li>
        </ol>
  </div> 
</div>
<div class="invoice">
  <section>
      <div class="row">
        <h4 class="purchase-heading">
          <i class="fa fa-pencil"></i> Credit Note
  ...
  <section class="content">
        <div class="box" id="print-section">
          <div class="box-body ">
            ...
            ?>
            <?php echo form_open_multipart('credit_note/update_credit_note',$attributes); ?>
            <div class="row">
               ...
               <div class="col-md-3 col-sm-12">
                  <div class="form-group">
                      ...
                      <?php               
                          $data = array('class'=>'form-control input-lg ','type'=>'date','name'=>'credit_date','value'=>$parent_row[0]->credit_date,'reqiured'=>'');
                          echo form_input($data);             
                      ?>
                  </div>
                </div> 
                  ...
                  <div class="col-md-12 table-responsive">
                      ...
                      <div class="col-md-5 ">
                        ...
                        <div class="form-group">
                            ...
                            <?php               
                                $data = array('class'=>'form-control input-lg ','type'=>'text','name'=>'memo','value'=>$parent_row[0]->memo,'reqiured'=>'');
                                echo form_input($data);             
                            ?>
                        </div>
                        <div class="form-group">
                          ...
                          <label> <i class="fa fa-paperclip" aria-hidden="true" ></i> Attachments  Maximum size: 25MB</label>
                            <?php               
                                ...
                                echo form_input($data);
                                 ...
                                 $data = array('class'=>'','type'=>'hidden','name'=>'credit_note_id','value'=>$parent_row[0]->id);
                                echo form_input($data);
                      ...
                      <div class="col-md-7">
                        <span class="pull-right">
                          <img class="img-setting" src="<?php echo base_url('uploads/credit_note/').$parent_row[0]->attachment;?>" >
                        </span>
                      </div>                   
                      <div class="col-md-12 ">
                          <div class="form-group">
