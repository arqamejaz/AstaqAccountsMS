...
<div class="invoice">
  <section>
      <div class="row">
        <h4 class="purchase-heading">
          <i class="fa fa-plus-circle"></i> Purchase Return Receipt
          <small>Create purchase return receipt for your purchases
  ...
  <section class="content">
        <div class="box" id="print-section">
          <div class="box-body ">
            <?php
                $attributes = array('id'=>'add_purchase_return','method'=>'post','class'=>'');
            ?>
            <?php echo form_open_multipart('Purchase_return/add_returnpurchase',$attributes); ?>
            <div class="row">
                  ...
                  <div class="col-md-12 table-responsive">
                       <table class="table table-striped table-hover  ">
                           <thead class="purchase-heading">
                            <tr>
                               <td class="col-md-2 ">Product/Service (<a  onclick="show_modal_page('<?php echo base_url();?>purchase_return/popup/add_product_model')" class="add-product-link" href="#"> Add New </a>)</td>
                      ...
                      <div class="col-md-5 ">
                        <div class="form-group">
                            <?php echo form_label('Message displayed on PR receipt :'); ?>
                            <?php               
