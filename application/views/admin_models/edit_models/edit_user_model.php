				  ...
				  ?>
				   ...
				   <?php echo form_label('User Contact1:'); ?>
					<?php
							...
							$data = array('class'=>'form-control input-lg','type'=>'text','name'=>'Edit_User_Contatc1','value'=>$single_user[0]->user_contact_1,'reqiured'=>'');
							echo form_input($data);
				   ?>
	              </div>
				   <div class="form-group">
				     <?php echo form_label('User Contact2(Optional):'); ?>
	                   <?php
							...
							$data = array('class'=>'form-control input-lg','type'=>'text','name'=>'Edit_User_Contatc2','value'=>$single_user[0]->user_contact_2,'reqiured'=>'');
							echo form_input($data);
						?>
	              </div>
			      <div class="form-group">
