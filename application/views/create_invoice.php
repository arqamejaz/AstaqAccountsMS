  ...
  <section>
      <div class="row">
        <h4 class="purchase-heading">
          ...
          <small>Create invoice and send it directly to account holder</small>
        </h4>
      </div>
  </section>
  <section class="content">
        <div class="box" id="print-section">
          <div class="box-body ">
            ...
            ?>
            <?php echo form_open_multipart('invoice/add_invoice',$attributes); ?>
            <div class="row">
               ...
               <div class="col-md-4 col-sm-12">
                ...
                <div class="col-md-4 col-sm-12">
                  <div class="form-group">
                      ...
                      <?php
                          $data = array('class'=>'form-control input-lg ','type'=>'date','name'=>'due_date','reqiured'=>'');
                          echo form_input($data);
                      ?>
                  </div>
                </div>
                  ...
                  <div class="col-md-12 table-responsive">
                       <table class="table table-striped table-hover  ">
                           <thead class="purchase-heading">
                            <tr>
                               <td class="col-md-2 ">
                                Product/Service (<a  onclick="show_modal_page('<?php echo base_url();?>invoice/popup/add_product_model')" class="add-product-link" href="#"> Add New </a>)
                               </td>
                           ...
                           <tfoot>
                              ...
                              <tr>
                                 ...
                                 <td>
                                     <?php
                                       $data = array('type'=>'number','name'=>'balance_due','step'=>'.01','value'=>'0.00','readonly'=>'readonly','class'=>'balance_due bill-total-settings','reqiured'=>'');
                                          echo form_input($data);
                                      ?>
                                 </td>
                              </tr>
