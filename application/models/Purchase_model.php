...
class Purchase_model extends CI_Model
{
    ...
    function add_purchase_receipt_transaction($data_fields)
    {
        $this->db->trans_start();
        $data1  = array(
        'date'                 => date('Y-m-d'), 
        'naration'             => $data_fields['memo'], 
        'generated_source'     => 'purchase_receipt'
        );
        ...
        $this->db->insert('mp_purchase_receipt',$data1);
        ...
        for ($i = 0; $i < count($data_fields['product']); $i++) 
        {
            ...
            $this->db->insert('mp_sub_purchase',$sub_data);
        }
    ...
    //USED TO UPDATE PURCHASE TRANSACTIONS 
    function update_purchase_receipt_transaction($data_fields)
    {
        $this->db->trans_start();
        ...
        $this->db->update('mp_purchase_receipt',$data);
        ...
        $this->db->delete('mp_sub_purchase');
